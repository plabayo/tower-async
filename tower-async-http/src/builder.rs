...
/// Extension trait that adds methods to [`tower_async::ServiceBuilder`] for adding middleware from
/// tower-http.
///
/// [`Service`]: tower_async::Service
///
/// # Example
///
/// ```rust
...
///
/// async fn handle(request: Request<Body>) -> Result<Response<Empty>, Infallible> {
...
/// # service.call(Request::new(Empty::new())).await.unwrap();
/// # }
/// ```
#[cfg(feature = "util")]
...
pub trait ServiceBuilderExt<L>: crate::sealed::Sealed<L> + Sized {
    ...
    ///
    /// [`tower_async_http::propagate_header`]: crate::propagate_header
    ...
    ///
    /// [`tower_async_http::add_extension`]: crate::add_extension
    ...
    ///
    /// [`tower_async_http::map_request_body`]: crate::map_request_body
    ...
    ///
    /// [`tower_async_http::map_response_body`]: crate::map_response_body
    ...
    ///
    /// [`tower_async_http::follow_redirect`]: crate::follow_redirect
    ...
    /// [`tower_async_http::sensitive_headers`]: crate::sensitive_headers
    ...
    ///
    /// [`tower_async_http::catch_panic`]: crate::catch_panic
    ...
    ///
    /// [`tower_async_http::normalize_path`]: crate::normalize_path
