...
//! # let http_client = tower_async::service_fn(|req: Request<_>| async move {
...
//! # let http_client =
//! #     tower_async::service_fn(|_: Request<Full<Bytes>>| async {
...
//!
//! // ...
//! # let _ = client.call(Request::default()).await?;
//! # Ok(())
//! # }
//! ```
