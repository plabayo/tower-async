...
//! use tower_async_http::cors::{Any, CorsLayer};
...
impl CorsLayer {
    ...
    ///
    /// ```
    /// use tower_async_http::cors::CorsLayer;
    ///
    ...
    /// use tower_async_http::cors::{CorsLayer, MaxAge};
    ///
    ...
    ///
    /// ```
    /// use tower_async_http::cors::{CorsLayer, AllowOrigin};
    /// use http::{request::Parts as RequestParts, HeaderValue};
    ///
    ...
    ResBody: Default,
{
    ...
    async fn call(&self, req: Request<ReqBody>) -> Result<Self::Response, Self::Error> {
        ...
        if parts.method == Method::OPTIONS {
            ...
            let mut response: Response<ResBody> = self.inner.call(req).await?;
